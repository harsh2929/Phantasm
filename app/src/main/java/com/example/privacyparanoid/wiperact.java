...
public class wiperact extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(ContextCompat.checkSelfPermission(wiperact.this,Manifest.permission.READ_SMS)==PackageManager.PERMISSION_DENIED){
